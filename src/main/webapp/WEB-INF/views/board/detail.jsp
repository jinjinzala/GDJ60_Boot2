                    ...
                    <div class="row gx-5">
                        <div class="col-lg-3">
                            <div class="d-flex align-items-center mt-lg-5 mb-4">
                                ...
                                <div class="ms-3">
                                    <div class="fw-bold">Valerie Luna ${board}</div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <article>
                                ...
                                <header class="mb-4">
                                    <!-- Post title-->
                                    <h1 class="fw-bolder mb-1">${boardVO.writer}</h1>
                                    <!-- Post meta content-->
                                    <div class="text-muted fst-italic mb-2">111</div>
                                    <!-- Post categories-->
